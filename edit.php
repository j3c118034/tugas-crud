...
<body>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "UPDATE mahasiswa SET nim = '$nim' ,nama='$nama', jenis_kelamin='$jenis_kelamin', agama='$agama', olahraga_fav='$olahraga_fav', gambar='$gambar'WHERE id='$id'") or die(mysqli_error($koneksi));
		...
		<form action="edit.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					...
					<option value="ISLAM" <?php if($data['agama'] == 'ISALAM') {echo "selected";}?>>ISLAM</option>
			...
			<div class="form-group row">
				...
				<?php $dataor =explode(", ", $_POST['olahraga_fav']); 
       			 ?>
				<div class="col-sm-10">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					...
					<input type="file" class="custome-file" name="gambar" >
				</div>
			</div>
			<div class="form-group row">
